...
NSString *const HEARTBEAT_TRACKING_SERVER = @"staacjapanconsulting.hb.omtrdc.net";
NSString *const HEARTBEAT_JOB_ID          = @"j2";
NSString *const HEARTBEAT_PUBLISHER       = @"test-publisher";
NSString *const HEARTBEAT_CHANNEL         = @"test-channel";
NSString *const HEARTBEAT_OVP             = @"test-ovp";
NSString *const HEARTBEAT_SDK             = @"test-sdk";
